...
<body >
	...
	<div style="width:100%; max-width: 1100px; float: right; position:relative;"> 
            {!!Form::open(array('route'=>'store_ordenc_convenio', 'id'=>'frmsave', 'method'=>'post','files'=>true))!!}
                                {{ csrf_field() }}
                    <div class="panel panel-success"style="width:100%; margin-top:20px;">
                            ...
                            <input type="hidden" name="run_c" value="{{$convenio->RUT_CLIENTE}}">
                            <input type="hidden" name="id_cot" value="{{$convenio->ID_CONVENIO}}">
                            <p>
