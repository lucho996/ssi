...
<body>
    ...
    <div style="width:100%; max-width:1100px;  margin: 0px auto 0px;">
                        ...
                        <img src="images/png/logo.png" style="width:200px; opacity:0.6;" style="margin: 0px auto;" alt="">
                        
                        
                        <div style="width:500px; height:80px; opacity: 0.7; float:right;">
                            <div style="margin-top: 30px; color:#5B9600;">
                                <div style="width:200px; float:left;">
                                <img src="images/png/fono.png"  style="width:60px; float: left;" alt="">
                                <div style="margin-top: 20px;">
                                <h4><em>041-2950458</em></h3>
                                </div>
                                </div>  
                                <div style="width:300px; float: right;">
                                    <img src="images/png/ubicacion.png"  style="width:60px; float: left;" alt="">
                                <div style="margin-top: 20px;">
